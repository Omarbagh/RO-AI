...
export function EducationStep({
  ...
  return (
    <div>
      ...
      <button
        type="button"
        className="w-full border-2 border-dashed border-purple-300 text-purple-600 hover:bg-purple-50 h-12 flex items-center justify-center gap-2 rounded-md mt-3"
