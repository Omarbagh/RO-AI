              ...
              >
                ...
                >
                  <ul className="flex gap-6">
                    {["Home", "Features", "How it works", "Pricing", "FAQ"].map(
                      (item) => (
                        <li key={item}>
                          <a
                            href="#"
                          ...
                          `}
                            style={{
                              whiteSpace:
                                item === "How it works" ? "nowrap" : "normal",
                            }}
                          >
                            {item}
                          </a>
                ...
                <div
                  ...
                  style={{
                    transition:
                      "max-height 0.4s cubic-bezier(.4,0,.2,1), opacity 0.3s cubic-bezier(.4,0,.2,1)",
                  }}
                >
                ...
                <div className="flex-1 flex justify-end items-center gap-4">
                  <SignedOut>
                    <SignInButton>
                      <Button
                        className="w-[100px] h-[36px] rounded-full bg-black py-2 px-3 text-sm md:w-[170px] md:h-[40px] md:px-4 md:text-sm transition-transform duration-200 text-white"
                        style={{
                          fontFamily: "Poppins, sans-serif",
                          fontWeight: 500,
                        }}
