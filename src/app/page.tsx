    ...
    <div className="relative min-h-screen">
      ...
      <main className="pt-[120px] sm:pt-[200px] px-4 flex flex-col items-center">
        ...
        <section className="mt-5 relative flex flex-col items-center">
          ...
          <div className="absolute left-[-120px] top-10 flex space-x-2">
            <img
              src="/cloud.png"
              alt="cloud"
              className="opacity-80 animate-fade-in-down"
              style={{ animationDelay: "1.1s" }}
            />
            <img
              src="/cloud.png"
              alt="cloud"
              className="opacity-60 animate-fade-in-down"
        ...
        <section className="mt-10 w-full max-w-[1800px] bg-[#EFECF9] h-[700px] rounded-2xl xl:max-w-[1800px]">
          <h1
            className="font-poppins text-center text-4xl sm:text-5xl font-bold text-[#1E293B] mb-4 mt-15 animate-fade-in-down"
            style={{
              fontFamily: "Poppins, sans-serif",
              animationDelay: "1.5s",
            }}
          ...
          >
            ...
            <br />
            Enter details, pick a style, and let AI optimize it. Download and
          ...
          >
            <img
              ...
              alt="Step 1"
              className="w-80 h-auto animate-fade-in-up"
        ...
        {/* 6. Key Features */}
        <h1
          className="font-poppins text-center text-4xl sm:text-5xl font-bold text-[#1E293B] mb-4 mt-25 animate-fade-in-down"
          style={{ fontFamily: "Poppins, sans-serif", animationDelay: "2.7s" }}
        >
          Key features
        </h1>
        <p
        ...
        >
          ...
          suggestions, customizable templates, real-time feedback, and one-click
          downloads. Stand out with tailored achievements, modern design, and
          seamless editing—all in one place.
        </p>
