...
export function ProfessionalTemplate({ data }: CVTemplateProps) {
  ...
  return (
    <div
      className="max-w-4xl mx-auto bg-white shadow-2xl font-sans grid grid-cols-1 md:grid-cols-[1fr,2.5fr]"
    ...
    >
      ...
      <main className="p-10">
        <section>
          ...
          <p
            className="text-sm text-gray-600 mt-4 leading-relaxed border-l-4 pl-4"
